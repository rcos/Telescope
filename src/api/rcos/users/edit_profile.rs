...
impl EditProfileContext {
    ...
    pub async fn get(username: String) -> Result<Option<edit_profile_context::EditProfileContextUsersByPk>, TelescopeError> {
...
impl SaveProfileEdits {
    ...
    pub async fn execute(username: String, first_name: String, last_name: String, cohort: Option<i64>, role: UserRole) -> Result<Option<String>, TelescopeError> {
