...
#[graphql(
    ...
    query_path = "graphql/rcos/discord_assoications/create_small_group_role.graphql",
)]
pub struct CreateOneSmallGroupRole;


impl CreateOneSmallGroupRole{
    pub async fn execute(small_group_id : i64,  role_id: String) -> Result<Option<String>, TelescopeError>{
